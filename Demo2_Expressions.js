...
var sum = 10 + 30; //Evaluates to numeric value

var greet = "Hello" + "World"; //Evaluates to string value 

var itemRating = 10;
var a = itemRating > 5; //Evaluates to boolean value

age = 20;
console.log((age > 60)? "Senior citizen": "Normal citizen");  // ternary Operator
